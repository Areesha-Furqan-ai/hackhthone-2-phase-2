            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4 flex justify-end space-x-3">
                  ...
                  <button
                    type="button"
                    className={`inline-flex justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 ${buttonTypeClasses[confirmButtonType]}`}
                    onClick={onConfirm}
                  >
                    {confirmText}
                  </button>
